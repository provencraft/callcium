...
[Git Source](https://github.com/provencraft/callcium/blob/main/packages/sdk/src/descriptor.ts#L378)
...
[Git Source](https://github.com/provencraft/callcium/blob/main/packages/sdk/src/descriptor-coder.ts#L480)
