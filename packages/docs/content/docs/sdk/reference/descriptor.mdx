...
[Git Source](https://github.com/provencraft/callcium/blob/main/packages/sdk/src/descriptor.ts#L286)
...
[Git Source](https://github.com/provencraft/callcium/blob/main/packages/sdk/src/descriptor-coder.ts#L517)
