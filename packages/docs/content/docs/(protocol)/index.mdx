...
The wire format is identical across environments — a policy built offchain enforces the same way as one built in Solidity. See the [Specifications](/docs/specifications/policy-v2) for the normative binary format.
